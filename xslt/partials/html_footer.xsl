            ...
            <div class="container-fluid pt-2">
                <div class="row justify-content-center">
                    <div class="col-lg-1 col-md-2 col-sm-2 col-xs-6 text-center">
                        <div>
                            <a href="https://www.oeaw.ac.at/acdh/"><img src="images/logo.png" class="image" alt="ACDH Logo" style="max-width: 100%; height: auto;" title="ACDH-CH Logo" /></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-3">
                        <div class="row">
                            <div>
                                ...
                                <br />
                                <p>ACDH betreibt einen Helpdesk mit Rat und Hilfestellung zu verschiedensten Fragen der Digital Humanities.
                                </p>
                                <p>
